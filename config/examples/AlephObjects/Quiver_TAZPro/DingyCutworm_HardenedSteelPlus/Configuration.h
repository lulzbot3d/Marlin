...
#define CUSTOM_MACHINE_NAME "LulzBot TAZ Pro" // <-- changed
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.102 // <-- changed:  Z offset: -below +above  [the nozzle]
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION -6 // <-- changed
...
#define LULZBOT_LCD_MACHINE_NAME "TAZ Pro" // <-- changed
#define LULZBOT_LCD_TOOLHEAD_NAME "HS+ 1.2mm" // <-- changed
#define LULZBOT_DETAILED_BUILD_VERSION " FIRMWARE_VERSION:" SHORT_BUILD_VERSION " EXTRUDER_TYPE:HardenedSteelPlus" // <-- changed
...
#define LULZBOT_RUNOUT_HANDLING_WORKAROUND // <-- changed
...
#define LULZBOT_DISABLE_DUE_SD_MMC // <-- changed
//#define LULZBOT_USE_UHS3_USB  // <-- changed
#define LULZBOT_ENERGIZE_Z_AT_STARTUP // <-- changed
#define LULZBOT_HOME_Z_AT_STARTUP // <-- changed
 ...
 */
#define LULZBOT_USB_DEVICE_VENDOR_ID 0x27b1 // <-- changed
#define LULZBOT_USB_DEVICE_PRODUCT_ID 0x0001 // <-- changed
#define LULZBOT_EEPROM_BACKUP_SIZE 1000 // <-- changed
