...
#define LULZBOT_LCD_TOOLHEAD_NAME "MOARstruder" // <-- changed
#define LULZBOT_DETAILED_BUILD_VERSION " FIRMWARE_VERSION:" SHORT_BUILD_VERSION " EXTRUDER_TYPE:MOARstruder" // <-- changed
