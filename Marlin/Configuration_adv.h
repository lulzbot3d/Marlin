 ...
 */
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #if ANY(TAZPro, TAZProXT)
      #if EITHER(LULZBOT_UNIVERSAL_TOOLHEAD, LULZBOT_UNIVERSAL_Xseries)
...
// Custom Menu: Main Menu
  ...
  #define CUSTOM_MENU_MAIN
    ...
    #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle
      ...
      #define E_CURRENT_LGX175 "155" //((850-750)/5+135) = 155
      #define E_CURRENT_LGX285 "177" //((960-750)/5+135) = 177
    #else
      #define E_CURRENT_LGX175 "850"
      #define E_CURRENT_LGX285 "960"
    #endif

    #if DISABLED(Workhorse)
      #define MAIN_MENU_ITEM_1_DESC "METEORITE-1.75|0.50mm|CRB CU"
      ...
      #define MAIN_MENU_ITEM_2_DESC "METEORITE-2.85|0.50mm|CRB CU"
      ...
      #define MAIN_MENU_ITEM_3_DESC "ASTEROID-2.85|0.50mm|CRB CU"
      #define MAIN_MENU_ITEM_3_GCODE "M92E415\nM301P" charMET285_DEFAULT_Kp "I" charMET285_DEFAULT_Ki "D" charMET285_DEFAULT_Kd "\nM906E" E_CURRENT_LGX285 "\nM500\nM117 METEORITE-2.85|0.50mm|CRB CU"
      ...
      #define MAIN_MENU_ITEM_3_DESC "ASTEROID-2.85|0.50mm|CRB CU"
      #define MAIN_MENU_ITEM_3_GCODE "M92E415\nM301P" charAST175_DEFAULT_Kp "I" charAST175_DEFAULT_Ki "D" charAST175_DEFAULT_Kd "\nM907E" E_CURRENT_LGX285 "\nM500\nM117 ASTEROID-2.85|0.50mm|CRB CU"
    #endif
