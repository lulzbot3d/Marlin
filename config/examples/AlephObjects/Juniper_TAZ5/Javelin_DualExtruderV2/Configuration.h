...
#define CUSTOM_MACHINE_NAME "LulzBot TAZ 5" // <-- changed
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100.5, 100.5, 1600, 830, 830} // <-- changed
...
#define LULZBOT_LCD_TOOLHEAD_NAME "Dual Extruder 2" // <-- changed
#define LULZBOT_DETAILED_BUILD_VERSION " FIRMWARE_VERSION:" SHORT_BUILD_VERSION " EXTRUDER_TYPE:DualExtruder v2" // <-- changed
