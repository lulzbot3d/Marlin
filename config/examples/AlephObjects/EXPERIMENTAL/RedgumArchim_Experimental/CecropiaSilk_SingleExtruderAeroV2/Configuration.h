...
#define CUSTOM_MACHINE_NAME "Archim Redgum" // <-- changed

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "fd546ced-5941-44e4-8d17-5d494bfc2ca3" // <-- changed
...
#define LULZBOT_LCD_MACHINE_NAME "Archim Redgum" // <-- changed
