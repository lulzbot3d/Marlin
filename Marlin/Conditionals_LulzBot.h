...
#define LULZBOT_FW_VERSION ".144.12" // Change this with each update
    ...
    !defined(TOOLHEAD_Twin_Nebula_285) && \
...
/*********************** AUTOLEVELING / BED PROBE *******************************/
    ...
    #define LULZBOT_STANDARD_LEFT_PROBE_BED_POSITION      30
    #define LULZBOT_STANDARD_RIGHT_PROBE_BED_POSITION     250//185
    #define LULZBOT_STANDARD_BACK_PROBE_BED_POSITION      250//291
    ...
    #define LULZBOT_STANDARD_LEFT_PROBE_BED_POSITION      10
    #define LULZBOT_STANDARD_RIGHT_PROBE_BED_POSITION     260//185
    #define LULZBOT_STANDARD_BACK_PROBE_BED_POSITION      570//291
    #define LULZBOT_STANDARD_FRONT_PROBE_BED_POSITION     20//-9
#endif
...
#define LULZBOT_MULTIPLE_PROBING              2
    ...
    #define LULZBOT_Y_PROBE_OFFSET_FROM_EXTRUDER  10
#else
...
//          16 chars max                            ^^^^^^^^^^^^^^^
    ...
    #define LULZBOT_TOOLHEAD_Y_MAX_ADJ             0
    #define LULZBOT_TOOLHEAD_Y_MIN_ADJ             0
    #define LULZBOT_TOOLHEAD_Z_MAX_ADJ            -105.9
    #define LULZBOT_TOOLHEAD_Z_MIN_ADJ             0
    #define LULZBOT_EXTRUDERS                      2
    #define LULZBOT_TOOLCHANGE_ZRAISE              0
    #define LULZBOT_NUM_SERVOS                     2
    ...
    #define LULZBOT_HOTEND_OFFSET_X               {0.0, 44}
    #define LULZBOT_HOTEND_OFFSET_Y               {0.0,  0}//M301 E1 P16.68 I1.07 D64.7
    #define LULZBOT_E_STEPS                        868
    #define LULZBOT_X_MAX_ENDSTOP_INVERTING        LULZBOT_NO_ENDSTOP
    #define LULZBOT_SLICE_MOS_PID
    #define LULZBOT_TEMP_SENSOR_1                  3
    #define LULZBOT_MOTOR_CURRENT_E0               850 // mA
    #define LULZBOT_MOTOR_CURRENT_E1               850 // mA
    #define SWITCHING_NOZZLE
    #define LULZBOT_SLOW_PWM_HEATERS
...
// Hotend variants
 ...
 //TAZ 6 Single Extruder (W)
  ...
  // MET175 Tool head (50W)
    #define MET175_DEFAULT_Kp 17.50
    #define MET175_DEFAULT_Ki 1.25
    #define MET175_DEFAULT_Kd 65.50
  ...
  // MET285 Tool head (50W)
    #define MET285_DEFAULT_Kp 17.50
    #define MET285_DEFAULT_Ki 1.25
    #define MET285_DEFAULT_Kd 59.30
  ...
  // AST285 Tool head (50W)
    ...
    #elif ENABLED(TOOLHEAD_whirlystruder)
      #define LULZBOT_DEFAULT_Kp  19.3
      #define LULZBOT_DEFAULT_Ki  2.1
      #define LULZBOT_DEFAULT_Kd  44.6
    #endif
  #endif
...
defined(LULZBOT_Gladiator_TAZProXT) && LULZBOT_EXTRUDERS == 1
    ...
    #if defined(LULZBOT_Quiver_TAZPro) && ANY(TOOLHEAD_Quiver_DualExtruder, TOOLHEAD_Twin_Nebula_175, TOOLHEAD_Twin_Nebula_285) || \
defined(LULZBOT_Gladiator_TAZProXT) && ANY(TOOLHEAD_Quiver_DualExtruder, TOOLHEAD_Twin_Nebula_175, TOOLHEAD_Twin_Nebula_285)
...
// Values for XYZ vary by printer model, values for E vary by toolhead.
  ...
  #define LULZBOT_Y_STEPS                      160
    ...
    #if defined LULZBOT_LONG_BED
      #define LULZBOT_DEFAULT_MAX_ACCELERATION      {9000,500,200,9000}
    #else
