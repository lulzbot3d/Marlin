...
#define X_BED_SIZE 277 // <-- changed
#define Y_BED_SIZE 269 // <-- changed

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS -6 // <-- changed
#define Y_MIN_POS -7 // <-- changed
#define Z_MIN_POS 0
#define X_MAX_POS 277 // <-- changed
#define Y_MAX_POS 269 // <-- changed
...
#define NOZZLE_PARK_FEATURE // <-- changed
  ...
  #define NOZZLE_PARK_POINT {100, 268, 20} // <-- changed
...
#define LULZBOT_DETAILED_BUILD_VERSION " FIRMWARE_VERSION:" SHORT_BUILD_VERSION " EXTRUDER_TYPE:DualExtruder v3" // <-- changed
