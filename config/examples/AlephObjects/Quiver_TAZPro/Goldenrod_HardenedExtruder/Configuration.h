...
#define LULZBOT_LCD_TOOLHEAD_NAME "HE 0.5mm" // <-- changed
#define LULZBOT_DETAILED_BUILD_VERSION " FIRMWARE_VERSION:" SHORT_BUILD_VERSION " EXTRUDER_TYPE:HardenedExtruder" // <-- changed
