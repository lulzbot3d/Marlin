...
#define CUSTOM_MACHINE_NAME "Archim TAZ 6" // <-- changed

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "a07987e3-7ca7-48e1-b7a4-cc2c45ff2742" // <-- changed
...
#define LULZBOT_LCD_TOOLHEAD_NAME "Single Extruder" // <-- changed
#define LULZBOT_DETAILED_BUILD_VERSION " FIRMWARE_VERSION:" SHORT_BUILD_VERSION " EXTRUDER_TYPE:SingleExtruder" // <-- changed
